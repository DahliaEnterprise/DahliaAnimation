...
void main( void )
{
	...
	if(distance_between_fragposition_and_lightposition_int > light_distance_int[0])
	{
		 if(distance_between_fragposition_and_lightposition_int < (light_distance_int[0] + light_distance_int[1]))
		 {
