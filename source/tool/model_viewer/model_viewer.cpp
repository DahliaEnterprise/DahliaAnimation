													...
													QVector3D offset_position_rotation[3])
{
		...
		line_shader_program->setUniformValueArray("offset_position_rotation", offset_position_rotation, 3);
		line_shader_program->enableAttributeArray(0);
		line_shader_program->enableAttributeArray(1);
	
		line_shader_program->setAttributeBuffer(0, GL_FLOAT, 0, 3, 6*sizeof(GLfloat));
		line_shader_program->setAttributeBuffer(1, GL_FLOAT, 3*sizeof(GLfloat), 3, 6*sizeof(GLfloat));
